...
public:
	...
	clone_pair_grid_layer(const shared_set<clone_pair> &clone_pairs, const int file_size) noexcept;

	void update(const shared_set<clone_pair> &clone_pairs, const int file_size) noexcept;
