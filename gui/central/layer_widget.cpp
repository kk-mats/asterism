	...
	: QWidget(parent)
{
	...
	connect(this->scatter_plot_widget_, &scatter_plot_widget::current_grid_changed, (matched_list_model *)this->matched_list_widget_->model(), &matched_list_model::change_current_grid);
	connect(this->scatter_plot_widget_, &scatter_plot_widget::current_grid_changed, this, &layer_widget::current_grid_changed);
